	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
			...
			$this->data['edit'] = url('admin/maincategory'); 
		...
		*/		
		...
		{			
			...
			try{
				...
				return redirect('admin/maincategory')->with('success', 'Maincategory Added Successfully');
        ...
        $file_name = time() . "." . $image->getClientOriginalExtension();
		 $image->move('admin/images/category', $file_name);
			...
			try{
				...
				return redirect('admin/maincategory')->with('success', 'Maincategory Updated Successfully');
			}
			catch(\Illuminate\Database\QueryException $e){ 
				return redirect()->back()->withInput()->with('failure', $e->getMessage());
			}
