	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $category=Category::where('cat_is_parent_id','=',null)->paginate(200);
			$category_list=array();
            ...
            $this->data['add'] = 'brandadmin.create';
			$this->data['edit'] = url('admin/brandadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('brandadmin.store');
		...
		*/		
		...
		{	
			...
			return redirect()->route('brandadmin.index')->with('success', 'Brand Created Successfully...!');	
		}		
		...
		*/		
		...
		{			
			...
			$this->data['route'] = array('brandadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.brand.addedit',$this->data);
		}		
		...
		*/		
		public function update(Request $request, $id)		
		{
            ...
            return redirect()->route('brandadmin.index')->with('success', 'Brand Updated Successfully...!');
		}		
