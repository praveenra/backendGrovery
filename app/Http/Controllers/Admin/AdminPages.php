	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'pagesadmin.create';
			$this->data['edit'] = url('admin/pagesadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('pagesadmin.store');
		...
		*/		
		...
		{			
			...
			try{
				...
				return redirect('admin/pagesadmin')->with('success', 'Page Added Successfully');
		...
		*/		
		...
		{			
			...
			$this->data['route'] = array('pagesadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.pages.addedit',$this->data);
		}		
