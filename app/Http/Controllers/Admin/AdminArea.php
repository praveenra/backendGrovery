<?php	
	...
	{		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'areaadmin.create';
			$this->data['edit'] = url('admin/areaadmin'); 
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('areaadmin.store');
		...
		{			
			...
			try{
				...
				return redirect('admin/areaadmin')->with('success', 'Area Added Successfully');
		...
		{			
            ...
            $this->data['cityvalue'] = City::allcities();
			$this->data['route'] = array('areaadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.area.addedit',$this->data);
		}		
		...
		public function update(Request $request, $id)		
		{
			...
			try{
				...
				return redirect('admin/areaadmin')->with('success', 'Area Updated Successfully');
			}
			catch(\Illuminate\Database\QueryException $e){ 
				return redirect()->back()->withInput()->with('failure', $e->getMessage());
			}
