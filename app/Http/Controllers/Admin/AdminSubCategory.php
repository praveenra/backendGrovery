	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'subcategoryadmin.create';
			$this->data['edit'] = url('admin/subcategoryadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('subcategoryadmin.store');
		...
		*/		
		...
		{	
			...
			return redirect()->route('subcategoryadmin.index')->with('success', 'Sub Category Created Successfully...!');	
		}		
		...
		*/		
		...
		{			
			...
			$this->data['route'] = array('subcategoryadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.subcategory.addedit',$this->data);
		}		
		...
		*/		
		...
		//	$slider->link = ($request->link) ? $request->link : '';			
            ...
            return redirect()->route('subcategoryadmin.index')->with('success', 'Sub Category Updated Successfully...!');
		}		
