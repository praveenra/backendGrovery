	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'banneradmin.create';
			$this->data['edit'] = url('admin/banneradmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('banneradmin.store');
		...
		*/		
		public function store(Addform $request)		
		{
			...
			return redirect()->route('banneradmin.index')->with('success', 'Banner Created Successfully...!');
		...
		{			
			...
			$this->data['route'] = array('banneradmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.banner.addedit',$this->data);
		}		
		...
		//	$slider->link = ($request->link) ? $request->link : '';			
            ...
            return redirect()->route('banneradmin.index')->with('success', 'Banner Updated Successfully...!');
		}		
