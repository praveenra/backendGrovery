	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'cityadmin.create';
			$this->data['edit'] = url('admin/cityadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('cityadmin.store');
		...
		*/		
		...
		{			
	        ...
	        $activity->updated_at = now();
				...
				return redirect('admin/cityadmin')->with('success', 'City Added Successfully');
		...
		*/		
		...
		{			
           ...
           // $this->data['cityvalue'] = City::allcities();
			$this->data['route'] = array('cityadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
		...
		*/		
		public function update(Request $request, $id)		
		{
	        ...
	        $activity->updated_at = now();
				...
				return redirect('admin/cityadmin')->with('success', 'City Updated Successfully');
			}
			catch(\Illuminate\Database\QueryException $e){ 
				return redirect()->back()->withInput()->with('failure', $e->getMessage());
			}
