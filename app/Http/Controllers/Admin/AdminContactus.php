	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'contactusadmin.create';
			$this->data['edit'] = url('admin/contactusadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('contactusadmin.store');
		...
		*/		
		...
		{			
	        ...
	        $activity->updated_at = now();
				...
				return redirect('admin/contactusadmin')->with('success', 'Contact Added Successfully');
		...
		*/		
		...
		{			
			...
			$this->data['route'] = array('contactusadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.contactus.addedit',$this->data);
		}		
		...
		*/		
		public function update(Request $request, $id)		
		{
	        ...
	        $activity->updated_at = now();
				...
				return redirect('admin/contactusadmin')->with('success', 'Contact Updated Successfully');
			}
			catch(\Illuminate\Database\QueryException $e){ 
				return redirect()->back()->withInput()->with('failure', $e->getMessage());
			}
