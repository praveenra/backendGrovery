	...
	{		
		...
		*/		
		...
		public function index(Request $request){			
            ...
            $this->data['add'] = 'deliveryadmin.create';
			$this->data['edit'] = url('admin/deliveryadmin'); 
		...
		*/		
		...
		{			
			...
			$this->data['page_details'] = $this->page_details;
            $this->data['route'] = array('deliveryadmin.store');
           // $this->data['cityvalue'] = City::allcitiesdelivery();
		...
		*/		
		...
		{	
			...
			try{
				...
				return redirect('admin/deliveryadmin')->with('success', 'Deliveryboy Added Successfully');
		...
		*/		
		...
		{			
		  ...
		  $this->data['cities'] = City::where('city_status',1)->get();
			$this->data['route'] = array('deliveryadmin.update',$id);
			$this->data['page_details'] = $this->page_details;
			return view('admin.delivery.addedit',$this->data);
		}		
		...
		*/		
		public function update(Request $request, $id)		
		{
			...
			try{
                ...
                return redirect('admin/deliveryadmin')->with('success', 'Deliveryboy Updated Successfully');
			}
			catch(\Illuminate\Database\QueryException $e){ 
				return redirect()->back()->withInput()->with('failure', $e->getMessage());
			}
