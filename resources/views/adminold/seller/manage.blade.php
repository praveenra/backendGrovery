         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="seller">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 40px;" onclick="location.href='{{url('admin/seller/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Seller Id</th>
