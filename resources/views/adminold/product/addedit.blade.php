...
$('#product_category_id').on('change',function(){
  ...
  if(cate_id){
    $.ajax({
      type:"GET",
      url:"{{url('admin/products/get_subcategory')}}?cate_id="+cate_id,
  ...
  if(cate_id){
    $.ajax({
      type:"GET",
      url:"{{url('admin/products/get_brand')}}?cate_id="+cate_id,
      success:function(res){        
      if(res){
        $("#brand_id").empty();
...
$('#sub_category_id').on('change',function(){
  ...
  if(sub_id){
    $.ajax({
      type:"GET",
      url:"{{url('admin/products/get_subsubcategory')}}?sub_id="+sub_id,
      success:function(res){        
      if(res){
...
function removeimages(id)
  {
	...
	$.ajax({
	  type:"GET",
	  url:"{{url('admin/products/remove_images')}}?id="+id,
	  success:function(res){  
	  }
	});		
  }
