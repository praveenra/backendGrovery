         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="product">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/products/create')}}'">Add New</a> &nbsp;
                <a href="javascript:" type="button" class="btn btn-primary" style="float: left; position: relative; left: 40px;" onclick="location.href='{{url('admin/products/uploadview')}}'">Upload</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Product Name</th>
