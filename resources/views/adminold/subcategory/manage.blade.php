         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="subcategory">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/subcategory/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Category Name</th>
