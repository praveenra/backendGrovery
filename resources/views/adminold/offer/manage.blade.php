         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="offer">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/offer/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Offer Name</th>
                        <th>Offer Amount</th>
                        <th>Offer Condition</th>
                        <th>Offer Code</th>
                        <th>Offer Status</th>
                        <th>Actions</th>
                     </tr>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteAdminOffer')}}" method="post">
              @csrf
