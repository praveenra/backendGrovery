...
<div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               <form action="{{ url('superadmin/city_update') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                @csrf

                <input type="hidden" value="{{$city->city_id}}" name="id">

                <div class="form-group">
                  <label for="city_name">City Name</label>
                  <input type="text" name="city_name" value="{{ $city->city_name }}"  class="form-control" placeholder="City Name" style="width: 50%;">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <input type="text" class="form-control" placeholder="Latitude" name="lat" id="lat" value="{{ $city->lat }}" >
                    </div>
                    <div class="col-lg-3">
                      <input type="text" class="form-control" placeholder="Longitude" name="long" id="long" value="{{ $city->long }}" >
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="city_status">City Status:</label><br>
                    <input type="radio" id="active" name="city_status"  value="1" {{'1' == $city->city_status ? 'checked' : ''}}>
                    <label for="active">Active</label>
                    <input type="radio" id="inactive" name="city_status" value="0" {{'0' == $city->city_status ? 'checked' : ''}}>
                    <label for="inactive">Inactive</label><br>  
                </div>

                <div class="form-group">
                  <label class="switch" for="buisness_switch">
                    <input type="checkbox" id="buisness_switch" name="buisness"  {{'on' == $city->buisness ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="buisness_image" id="buisness_image1" value="{{ $city->buisness_image }}" class="form-control" onchange="loadImage(this);" style="width: 50%;"disabled="">
                    <div style="margin-left:10px;"><br>
                        <img src="" id="img_preview">
                    </div>
                  <input type="text" name="buisness_text" id="buisness_text1" value="{{ $city->buisness_text }}" class="form-control" style="width: 50%;"disabled="">
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox"   name="promo_available" {{'on' == $city->promo_available ? 'checked' : ''}}>
                    <span class="slider round"></span>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="pay_by_cash" {{'on' == $city->pay_by_cash ? 'checked' : ''}}>
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox"  name="other_payment_method" {{'on' == $city->other_payment_method ? 'checked' : ''}}>
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox"  name="wallet_in_cash" {{'on' == $city->wallet_in_cash ? 'checked' : ''}}>
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="wallet_in_other" {{'on' == $city->wallet_in_other ? 'checked' : ''}}>
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="received_cash_payment" {{'on' == $city->received_cash_payment ? 'checked' : ''}}>
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <input type="text" value="{{ $city->min_amount }}" name="min_amount">
                </div>
  ...
  <div id="Delivery_area" class="w3-container city grid" style="display:none">
    ...
    <br>
     <div class="mapform" >
      ...
      <div class="form-group">
        <label class="switch">
        <input type="checkbox" id="use_radius" name="use_radius"  {{'on' == $city->use_radius ? 'checked' : ''}}>
        <span class="slider round"></span>
        </label>
      ...
      <div class="form-group">
      <input type="text" name="radius" id="radius" value="{{ $city->radius }}"  class="form-control" placeholder="Radius" disabled>
      </div>

      <div class="form-group">
      <input type="text" name="area" id="area" value="{{ $city->area }}" class="form-control" placeholder="Area" disabled>
      </div>
  ...
  <div id="Zone" class="w3-container city grid" style="display:none">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label class="switch">
        <input type="checkbox" id="use_zone" name="zone" {{'on' == $city->zone ? 'checked' : ''}}>
        <span class="slider round"></span>
        </label>
        <label for="wallet_in_other">Zone Business</label>
        <input type="text" name="vertices" id="vertices" value="{{ $city->vertices }}" class="form-control" readonly>
      </div>


      <div class="form-group">
      <input type="text" name="zone_name" id="zone" value="{{ $city->zone_name }}" class="form-control" placeholder="Zone Name" disabled>
      </div>
