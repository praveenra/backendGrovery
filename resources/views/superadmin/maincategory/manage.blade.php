         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="maincategory">
                ...
                <a href="{{url('superadmin/maincategory/create')}}" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteMainCategory')}}" method="post">
              @csrf
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('superadmin/filter_maincategory')}}",
              method:"GET",
              data:{
                status:status
              },
