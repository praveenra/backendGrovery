         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="settings">
                <a href="{{url('superadmin/settings/create')}}" type="button" class="btn btn-info" style="float: left;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Seller</th>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteSetting')}}" method="post">
              @csrf
