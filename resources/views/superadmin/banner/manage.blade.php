         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="banner">
                ...
                <a href="{{url('superadmin/banner/create')}}" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Banner Name</th>
  ...
  $(document).ready(function(){
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('superadmin/filter_banner')}}",
              method:"GET",
              data:{
                status:status
              },
