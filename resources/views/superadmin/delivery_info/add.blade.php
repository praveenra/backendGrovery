...
<div class="content-wrapper">
  ...
  <form action="{{ url('superadmin/delivery_info_store') }}" method="POST" enctype="multipart/form-data">
    @csrf

    <div id="Service_data" class="w3-container delivery_info grid" style="float: left; left: 5%; width: 35%;">
            ...
            <div class="card-body">
               <h4 class="card-title">Delivery Info</h4>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="city_name" class="form-control" placeholder="Title" >
                </div>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="buisness">
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="use_distance_calculation" id="customSwitch">
                    <span class="slider round"></span>
                ...
                <div class="form-group">
                  ...
                  <select type="text" name="profit_mode" class="form-control" placeholder="Profit Mode<">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="profit_value" class="form-control" placeholder="Profit Value" >
                </div>
  ...
  <div id="delivery_price_setting1" class="w3-container delivery_info grid" style="float: left; left: 35%; width: 30%;" disabled >
            ...
            <div class="card-body">
               <h4 class="card-title">Delivery Price Setting(Km)</h4>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="base_price_distance" class="form-control" placeholder="Base Price Distance">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="price_per_unit_distance" class="form-control" placeholder="Price Per Unit Distance">
                </div>

                <div class="form-group">
                  <label for="price_per_unit_time"> Price Per Unit Time</label>
                  <input type="text" name="price_per_unit_time" class="form-control" placeholder="Price Per Unit Time">
                </div>

                <div class="form-group">
                  <label for="service_tax">Service Tax</label>
                  <input type="text" name="service_tax" class="form-control" placeholder="Service Tax" >
                </div>

                <div class="form-group">
                  <label for="min_fare">Min Fare</label>
                  <input type="text" name="min_fare" class="form-control" placeholder="Min Fare" >
                </div>
       ...
       <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               <table class="table table-bordered table-striped" id="PriceSetting_AddRemove">
                ...
                <tr>
                  ...
                  <td>   
                    <input type="number" name="addMoreInputFields[0][from_distance]" placeholder="From Distance" class="form-control" >
                  </td>

                  <td>
                    <input type="number" name="addMoreInputFields[0][to_distance]" placeholder="To Distance" class="form-control" >
                  </td>

                  <td>
                    <input type="number" name="addMoreInputFields[0][delivery_fee]" placeholder="Deleivery Fee" class="form-control" >
                  </td>

                  <td><button type="button" name="add" id="addmore_PriceSetting" class="btn btn-sm btn-outline-primary">+Add More+</button></td>
            ...
            <div class="card-body">
               ...
               <table class="table table-bordered table-striped" id="Zoneprice_AddRemove">
                ...
                <tr>
                  ...
                  <td>
                    <select type="text" name="addMoreInputFields[0][select_zone1]" class="form-control" placeholder="Select Zone1">
                  ...
                  <td>
                    <select type="text" name="addMoreInputFields[0][select_zone2]" class="form-control" placeholder="Select Zone2">
                  ...
                  <td>
                    <input type="text" name="addMoreInputFields[0][amount]" class="form-control" placeholder="Amount">
                  </td>
...
<script type="text/javascript">
  $(document).ready(function(){
    var i = 0;
    $("#addmore_PriceSetting").click(function () {
        ++i;
        $("#PriceSetting_AddRemove").append('<tr> <td><input type="number" name="addMoreInputFields[' + i +'][from_distance]" placeholder="From Distance" class="form-control" /> </td> <td> <input type="number" name="addMoreInputFields[' + i +'][to_distance]" placeholder="To Distance" class="form-control" /> </td> <td> <input type="number" name="addMoreInputFields[' + i +'][delivery_fee]" placeholder="Delivery Fee" class="form-control" /> </td> <td><i class="fa fa-times btn_remove" name="remove" style="cursor: pointer; color: red; font-size: 20px;"></i></td></tr>'
            );
    });
