         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="contactus">
                ...
                <a href="{{url('superadmin/contactus/create')}}" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Email</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"{{route('inactiveContactUs')}}?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"{{route('activeContactUs')}}?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('superadmin/filter_contactus')}}",
              method:"GET",
              data:{
                status:status
              },
