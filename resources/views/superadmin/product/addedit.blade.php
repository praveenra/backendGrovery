                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @if( $errors->has('product_category_id') )
                                <div
                                    class="error_span help-text text-danger"> {{ $errors->first('product_category_id') }}</div>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('product_short_description'))
                                <div
                                    class="error_span help-text text-danger">{{ $errors->first('product_short_description') }}</div>
                            @endif
                        </div>
                        <div class="form-group">
                            ...
                            @if($errors->has('product_long_description'))
                                <div
                                    class="error_span help-text text-danger">{{ $errors->first('product_long_description') }}</div>
                            @endif
                        </div>
                    ...
                    @endif
                                    ...
                                    @foreach($product_quantity as $key => $data)
                                        <tr>
                                            ...
                                            <td><input type="checkbox"
                                                       name="form_data[{{$key}}][availability]" {{$data->availability == "on" ? "checked" : ""}}>
                                            </td>
                                            <td><input type="text" class="form-control"
                                                       name="form_data[{{$key}}][measurement]" placeholder="Measurement"
                                                       value="{{$data->measurement}}"></td>
                                            <td><input type="text" class="form-control price"
                                                       name="form_data[{{$key}}][price]" placeholder="Price"
                                                       value="{{$data->price}}" required></td>
                                            <td><input type="text" class="form-control sales_price"
                                                       name="form_data[{{$key}}][sales_price]" placeholder="Sales Price"
                                                       value="{{$data->sales_price}}" required></td>
                                            <td><input type="text" class="form-control offer"
                                                       name="form_data[{{$key}}][offer]" placeholder="Offer"
                                                       value="{{$data->offer}}" readonly></td>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="main_image" value="{{old('main_image')}}" class="form-control"
                        ...
                        <!-- {{ Form::file('main_image', old('main_image'), ['class' => 'form-control']) }} -->
                            ...
                            @if($senddata['main_image']!="")
                                <img src="{{url('admin/images/products/')}}/{{$senddata['main_image']}}" height="100"
                        ...
                        @if($senddata['product_id']!="")
                            <div class="form-group">
                                <div class="box">

                                    @foreach($upload as $uploads)

                                        <div id="div_{{$uploads['id']}}"><img
                                                src="{{url('/admin/images/products/')}}/{{$uploads['image_name']}}"
                                                height="100" width="100" id="preview_{{$uploads['id']}}"><a
                                                style="cursor:pointer" onclick="removeimages({{$uploads['id']}})"
                        ...
                        <div class="row m-t-50">
                            <div class="col-md-6" style="margin-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('colorName[]', $ProductColor, json_decode($productColors ?? null)  ,  ['class' => 'form-control selectMultiple', 'multiple' => 'multiple']) !!}
                            ...
                            <div class="col-md-6" style="margin-top:30px;">
                                ...
                                {!! Form::select('sizeName[]', $ProductSize, json_decode($productSizes ?? null) , ['class' => 'form-control selectMultipleSize', 'multiple' => 'multiple']) !!}
