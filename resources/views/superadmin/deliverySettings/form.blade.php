...
<div class="content-wrapper">
   <div class="page-header">
      <h3 class="page-title"> {{$action}} Setting </h3>
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">SuperAdmin</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$action}} Setting</li>
         </ol>
      </nav>
   </div>
   <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               <form action="{{route('saveDeliverySettings')}}" method="post">
                @csrf
                    ...
                    <tbody>
                      @if($action == 'Add')
                        ...
                        @elseif($action == 'Edit')
                          ...
                          <tr>
                            <!-- <td><input type="checkbox" class="custom-control-input" id="customSwitch8" name="form_data[{{$key}}][on_off]">
                              <label class="custom-control-label" for="customSwitch8"></label>
                           </td> -->
                           
                            <td>
                            <label class="switch" for="customSwitch{{$key}}">
                          <input type="checkbox" name="form_data[{{$key}}][on_off]" id="customSwitch{{$key}}" {{$data->on_off == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                        </label>
                            </td>
                            <td><input type="text" name="form_data[{{$key}}][opening_day]" class="form-control" value="{{$data->opening_day}}" id="edit1" readonly ></td>
                            <td><input type="time" name="form_data[{{$key}}][start_time]" class="form-control" value="{{$data->start_time}}" id="edit2" ></td>
                            <td><input type="time" name="form_data[{{$key}}][end_time]" id="edit3"  class="form-control" value="{{$data->end_time}}" ></td>
                            <td><input type="text" name="form_data[{{$key}}][minutes]" class="form-control" value="{{$data->minutes}}" id="edit4" ></td>
                          </tr>
                          @endforeach
                        @endif
                    </tbody>
