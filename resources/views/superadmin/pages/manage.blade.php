         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="pages">
                ...
                <a href="{{url('superadmin/pages/create')}}" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Page Type</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('superadmin/filter_pages')}}",
              method:"GET",
              data:{
                status:status
              },
