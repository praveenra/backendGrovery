         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="subcategory">
                ...
                <a href="{{url('superadmin/subcategory/create')}}" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Category Name</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      function filter(status = '', category = '') {
          $.ajax({
              url:"{{ url('superadmin/filter_subcategory')}}",
              method:"GET",
              data:{
