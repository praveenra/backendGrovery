      ...
      <div class="col-md-6 grid-margin stretch-card">
        ...
        <p id="MainCategory" style="color:red;"></p>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <label class="switch">
                  @if($seller->sd_business === 1 || $seller->sd_business === 0 )
                    <input type="checkbox" name="storedetails[sd_business]" id="customSwitch" {{$seller->sd_business == 1 ? "checked" : ""}}>
                  @else if
                    <input type="checkbox" name="storedetails[sd_business]" id="customSwitch" class="form-control" checked="checked">
                  @endif
                    <!-- {{!! Form::checkbox('storedetails[sd_business]',old('sd_business'), $seller->sd_business==1 ? ['class' => 'form-control'] : '') !!}} -->
                     ...
                     <tr>
                       <td>
                        <label class="switch" for="customSwitch1">
                          <input type="checkbox" name="storedetails[sunday_check]" id="customSwitch1" {{$seller->sunday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[sunday_opening_time]" id="sunday_off1"  value="{{$seller->sunday_opening_time}}" class="form-control sunday_opening_time">
                          <input type="time" name="storedetails[sunday_closing_time]" id="sunday_off2"  value="{{$seller->sunday_closing_time}}" class="form-control sunday_closing_time">
                        </td>
                       <td>
                        <label class="switch" for="customSwitch2">
                          ...
                          <input type="checkbox" name="storedetails[monday_check]" id="customSwitch2" {{$seller->monday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[monday_opening_time]" id="monday_off1" value="{{$seller->monday_opening_time}}" class="form-control monday_opening_time">
                          <input type="time" name="storedetails[monday_closing_time]" id="monday_off2" value="{{$seller->monday_closing_time}}" class="form-control monday_closing_time">
                        </td>
                        <td>
                        <label class="switch" for="customSwitch3">
                          ...
                          <input type="checkbox" name="storedetails[tuesday_check]" id="customSwitch3" {{$seller->tuesday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[tuesday_opening_time]" id="tuesday_off1" value="{{$seller->tuesday_opening_time}}" class="form-control tuesday_opening_time">
                          <input type="time" name="storedetails[tuesday_closing_time]" id="tuesday_off2" value="{{$seller->tuesday_closing_time}}" class="form-control tuesday_closing_time">
                        </td>
                        <td>
                        <label class="switch" for="customSwitch4">
                          ...
                          <input type="checkbox" name="storedetails[wednesday_check]" id="customSwitch4" {{$seller->wednesday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[wednesday_opening_time]" id="wednesday_off1" value="{{$seller->wednesday_opening_time}}" class="form-control wednesday_opening_time">
                          <input type="time" name="storedetails[wednesday_closing_time]" id="wednesday_off2" value="{{$seller->wednesday_closing_time}}" class="form-control wednesday_closing_time">
                        </td>
                        <td>
                        <label class="switch" for="customSwitch5">
                          ...
                          <input type="checkbox" name="storedetails[thursday_check]" id="customSwitch5" {{$seller->thursday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[thursday_opening_time]" id="thursday_off1" value="{{$seller->thursday_opening_time}}" class="form-control thursday_opening_time">
                          <input type="time" name="storedetails[thursday_closing_time]" id="thursday_off2" value="{{$seller->thursday_closing_time}}" class="form-control thursday_closing_time">
                        </td>
                        <td>
                        <label class="switch" for="customSwitch6">
                          ...
                          <input type="checkbox" name="storedetails[friday_check]" id="customSwitch6" {{$seller->friday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[friday_opening_time]" id="friday_off1" value="{{$seller->friday_opening_time}}" class="form-control friday_opening_time">
                          <input type="time" name="storedetails[friday_closing_time]" id="friday_off2" value="{{$seller->friday_closing_time}}" class="form-control friday_closing_time">
                        </td>
                        <td>
                        <label class="switch" for="customSwitch7">
                          ...
                          <input type="checkbox" name="storedetails[saturday_check]" id="customSwitch7" {{$seller->saturday_check == 1 ? "checked" : ""}}>
                          <span class="slider round"></span>
                          </label>
                          <input type="time" name="storedetails[saturday_opening_time]" id="saturday_off1" value="{{$seller->saturday_opening_time}}" class="form-control saturday_opening_time">
                          <input type="time" name="storedetails[saturday_closing_time]" id="saturday_off2" value="{{$seller->saturday_closing_time}}" class="form-control saturday_closing_time">
                        </td>
                     </tr>
                   </tbody>
                 </table>
