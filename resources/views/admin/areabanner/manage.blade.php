      ...
      <div class="col-lg-12 grid-margin stretch-card">
         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="areabanner">
                <a href="javascript:" type="button" class="btn btn-primary" style="float: left;" data-toggle="modal" data-target="#filter">Filter</a>
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/areabanneradmin/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Banner Name</th>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteAdminAreaBanner')}}" method="post">
              @csrf
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="custom-width-modalLabel">Delete Area Banner</h4>
                </div>
   ...
   $(function () {
    ...
    $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('admin/filter_areabanner')}}",
              method:"GET",
              data:{
                status:status
              },
