         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="maincategory">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/maincategoryadmin/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><img src="{{url('admin/images/category/')}}/{{$data->image}}"></td>
                        @if($data->mc_status == 1)
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteAdminMainCategory')}}" method="post">
              @csrf
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"{{ url('admin/filter_maincategory')}}",
              method:"GET",
              data:{
                status:status
              },
