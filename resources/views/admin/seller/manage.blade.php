         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="seller">
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left;" onclick="location.href='{{url('admin/export_sellers')}}'">Export</a> &nbsp;
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 40px;" onclick="location.href='{{url('admin/selleradmin/create')}}'">Add New</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Seller Id</th>
