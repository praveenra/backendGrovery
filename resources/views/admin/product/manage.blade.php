         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="product">
                ...
                <a href="javascript:" type="button" class="btn btn-warning" style="float: left; position: relative; left: 20px;" onclick="location.href='{{url('admin/productsadmin/create')}}'">Add New</a> &nbsp;
                <a href="javascript:" type="button" class="btn btn-primary" style="float: left; position: relative; left: 40px;" onclick="location.href='{{url('admin/productsadmin/uploadview')}}'">Upload</a> &nbsp;
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Product Name</th>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="{{route('deleteAdminProduct')}}" method="post">
              @csrf
