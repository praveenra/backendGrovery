...
<?php $__env->startSection('title','Delivery Executive'); ?> 
         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="delivery">
                ...
                <a href="<?php echo e(url('superadmin/delivery/create')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Care Giver ID</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <img src="<?php echo e(asset('public/admin/images/caregiver')); ?>/<?php echo e($data->care_giver_image); ?>"  style="width:50px; height:50px; float:left; border-radius:50%; margin-right:25px;">
                        </td>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="<?php echo e(route('deleteDelivery')); ?>" method="post">
              <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactiveDelivery')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activeDelivery')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(function () {
    ...
    $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_delivery')); ?>",
              method:"GET",
              data:{
                status:status
              },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\backendGrovery\resources\views/superadmin/delivery/manage.blade.php ENDPATH**/ ?>