         ...
         <div class="card">
            <div class="card-body table-responsive">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                          <form method="post" class="modal-content" action="<?php echo e(route('orderfilter')); ?>" style="border: none;">
                            <?php echo csrf_field(); ?>
                            <td>
                            ...
                            <td>
                                 <a href="javascript:" type="button" class="btn btn-warning"  style="float: left; position: relative; left: 10px;" onclick="location.href='<?php echo e(url('superadmin/export_orders')); ?>'">Export</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
               ...
               <table class="table table-striped" id="orders">
                  ...
                  <tbody>
                     ...
                     <?php $__empty_1 = true; $__currentLoopData = $order_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                     <tr>
                        <td><?php echo e($key+1); ?></td>
                        <td><?php echo e($slider->order_id); ?></td>
                        <td><?php echo e($slider->customer); ?></td>
                        <td><?php echo e($slider->store_name); ?></td>
                        <td><?php echo e($slider->payment_type); ?></td>
                        <td><?php echo e(date('d-m-Y h:i a', strtotime($slider->created_time))); ?></td>
                        <td>
                            <?php if($slider->delivery_man == ''): ?>
                                <span style="color: red;">Please Assign Delivery Boy</span>
                            <?php else: ?>
                                 <button class="btn-success" style="color: red;"><?php echo e($slider->delivery_boy_name); ?></button>
                            <?php endif; ?>
                        </td>

                        <?php if($slider->order_status == ''): ?>
                            <td><button class="btn-approve approve_check"  style="color: red;" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" data-target="#approveOrReject">Approve Order</button></td>
                        <?php elseif($slider->order_status == 1): ?>
                            <td><button class="btn-approve approve_check" style="color: red;" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" data-target="#approveOrReject"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php elseif($slider->order_status == 2): ?>
                            <td><button class=" btn-progress progress_check delivery_man_assign_check" style="color: orange;" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" data-target="#Ready_for_Pickup"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php elseif($slider->order_status == 3): ?>
                           <td><button class="btn-pickup out_for_delivery_check" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" data-target="#out_for_delivery_order"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php elseif($slider->order_status == 7): ?>
                            <td><button class="btn-approve complete_check" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" style="color: brown;" data-target="#complete_order"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php elseif($slider->order_status == 4): ?>
                            <td><button class="btn-success return_check" style="color: green;" data-id="<?php echo e($slider->order_main_id); ?>" data-toggle="modal" data-target="#return_order"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php elseif($slider->order_status == 5): ?>
                            <td><button class="btn-approve"><?php echo e($slider->order_status_name); ?></button></td>
                            <!-- <td><button class="btn-danger" style="color: red;"><?php echo e($slider->order_status_name); ?></button></td> -->
                        <?php elseif($slider->order_status == 6): ?>
                            <td><button class="btn-approve" style="color: black;"><?php echo e($slider->order_status_name); ?></button></td>
                        <?php endif; ?>

                       
                        <td>
                          <a href="javascript:;" class="order_details_modal" data-id="<?php echo e($slider->order_id); ?>" data-storeid="<?php echo e($slider->store_id); ?>" data-toggle="modal" data-target="#view" title="view"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;
                        </td>
                     </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('approveOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="Ready_for_Pickup" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('proceedOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="Assign_Delivery_Man" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('checkDeliveryman')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="out_for_delivery_order" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('outfordeliveryOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="complete_order" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('completeOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="return_order" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('returnOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="deliveryMan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="modal-content" action="<?php echo e(route('assignDeliveryman')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                  </div><br><br>
                  <div class="row">
...
<div id="cancel_order" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo e(route('cancelOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
                     <input type="hidden" name="id" id="id">
                     <input type="hidden" name="user_id" id="loginuser" >
                     <input type="hidden" name="sd_id" id="sd_id" >
                     <?php $__currentLoopData = $cancel_reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="radio" name="reason" value="<?php echo e($data->id); ?>"> <?php echo e($data->reason); ?> <br><br>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     <br>
...
<div id="cancel_ind_order" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo e(route('cancelIndividualOrder')); ?>" style="border: none;">
                    <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      function filter(from_date = '', to_date = '') {
            ...
            $.ajax({
                url:"<?php echo e(url('superadmin/filter_manage_orders')); ?>",
                method:"GET",
                data:{
  ...
  $(document).ready(function(){
    $('.order_details_modal').click(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('superadmin/view_order_store')); ?>" + '/' + order_id + '/' + store_id,
            type: 'GET',
            dataType: 'json',
   ...
   $(function () {
    ...
    function assigndeliveryboy(){
        $.ajax({
                type: "GET",
                url:"<?php echo e(url('superadmin/delivery_city/assigncaregiver')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/orders/manage.blade.php ENDPATH**/ ?>