...
<?php $__env->startSection('title','Complete And Return Orders'); ?> 
...
<div class="content-wrapper">
   <div class="page-header">
      <h3 class="page-title"> Complete And Return Orders</h3>
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">SuperAdmin</a></li>
            <li class="breadcrumb-item active" aria-current="page">Complete And Return Orders</li>
         </ol>
      </nav>
   </div>
   <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\backendGrovery\resources\views/superadmin/orders/complete_and_return_order.blade.php ENDPATH**/ ?>