...
<?php $__env->startSection('title','Waiting For Approve Orders'); ?> 
...
<div class="content-wrapper">
   <div class="page-header">
      <h3 class="page-title"> Waiting For Approve Orders</h3>
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">SuperAdmin</a></li>
            <li class="breadcrumb-item active" aria-current="page">Waiting For Approve Orders </li>
         </ol>
      </nav>
   </div>
   <div class="row">
            ...
            <div class="card-body table-responsive">
               ...
               <table class="table table-striped" id="orders">
                  ...
                  <tbody>
                     ...
                     <?php $__empty_1 = true; $__currentLoopData = $wait_for_approve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\backendGrovery\resources\views/superadmin/orders/waiting_for_approval_order.blade.php ENDPATH**/ ?>