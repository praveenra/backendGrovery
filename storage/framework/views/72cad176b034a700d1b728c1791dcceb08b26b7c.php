...
<?php $__env->startSection('title','Store Reviews'); ?> 
         ...
         <div class="card">
          <div class="card-body table-responsive">
            <a href="javascript:" type="button" class="btn btn-danger pull-right" style="float: right;" onclick="changeAllStatus()">Approve and Publish All</a>
               <table class="table table-striped" id="store_reviews">
                  <thead>
                     <tr>
                        <th>S.No</th>
                        <th>Store</th>
                        ...
                        <td> 
                          ...
                          <script>
                              ...
                              function changestatus(id){
                                  ...
                                  $.ajax({
                                      type:"GET",
                                      url:"<?php echo e(url('superadmin/change_review_status')); ?>?id="+id+"&status="+status,
                              ...
                              function changeAllStatus(id){
                                  ...
                                  $.ajax({
                                      type:"GET",
                                      url:"<?php echo e(url('superadmin/change_all_review_status')); ?>",
                                      success:function(res){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/reviews/store_reviews.blade.php ENDPATH**/ ?>