         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="banner">
                ...
                <a href="<?php echo e(url('superadmin/banner/create')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Banner Name</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo e($slider->banner_name); ?></td>
                        <td><img width="100px" src="<?php echo e($slider->SliderImage()); ?>"></td>
                        <?php if($slider->banner_status == 1): ?>
                        <td><a href="javascript:" class="badge badge-success active" data-id='<?php echo e($slider->banner_id); ?>' style="cursor: pointer;">Active</a></td>
                        <?php else: ?>
                        <td><a href="javascript:" class="badge badge-danger inactive" data-id='<?php echo e($slider->banner_id); ?>' style="cursor: pointer;">Inactive</a></td>
                        <?php endif; ?>
                        <td>
                           <a href="<?php echo e(url($edit).'/'.$slider->banner_id.'/edit'); ?>"><img src="<?php echo e(asset('public/edit.svg')); ?>"></a>&nbsp;
                           <a class="delete" href="javascript:;" data-toggle="modal" data-id='<?php echo e($slider->banner_id); ?>' data-target="#delete"><img src="<?php echo e(asset('public/delete.svg')); ?>"></a> 
                         </td>
                     </tr>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="<?php echo e(route('deleteBanner')); ?>" method="post">
              <?php echo csrf_field(); ?>
  ...
  $(document).ready(function(){
    $(".delete").click(function(){
     ...
     $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactiveBanner')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activeBanner')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_banner')); ?>",
              method:"GET",
              data:{
                status:status
              },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/banner/manage.blade.php ENDPATH**/ ?>