               ...
               <table class="table table-striped" id="orders">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                          <a href="javascript:;" class="order_details_modal" data-id="<?php echo e($slider->order_id); ?>" data-toggle="modal" data-target="#view" title="view"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;
                        </td>
                     </tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $('.order_details_modal').click(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('superadmin/view_order')); ?>" + '/' + order_id,
            type: 'GET',
            dataType: 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/mahe/latestcodeteam/GroveryVThree/Grovery/resources/views/superadmin/orders/manage.blade.php ENDPATH**/ ?>