      ...
      <div class="col-lg-12 grid-margin stretch-card">
         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="subcategory">
                <a href="javascript:" type="button" class="btn btn-primary" style="float: left;" data-toggle="modal" data-target="#filter">Filter</a>
                <a href="<?php echo e(url('superadmin/subcategory/create')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Category Name</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo e($slider->subcategory->cat_name); ?></td>
                        <td><?php echo e($slider->cat_name); ?></td>
                        <td><img width="100px" src="<?php echo e(asset('admin/images')); ?>/<?php echo e($slider->cat_image); ?>"></td>
                        <?php if($slider->cat_status == 1): ?>
                        <td><a href="javascript:" class="badge badge-success active" data-id='<?php echo e($slider->cat_id); ?>' style="cursor: pointer;">Active</a></td>
                        <?php else: ?>
                        <td><a href="javascript:" class="badge badge-danger inactive" data-id='<?php echo e($slider->cat_id); ?>' style="cursor: pointer;">Inactive</a></td>
                        <?php endif; ?>
                        <td >

                            <a href="<?php echo e(url($edit).'/'.$slider->cat_id.'/edit'); ?>"><img src="<?php echo e(asset('public/edit.svg')); ?>"></a>&nbsp;
                           <a class="delete" href="javascript:;" data-toggle="modal" data-id='<?php echo e($slider->cat_id); ?>' data-target="#delete"><img src="<?php echo e(asset('public/delete.svg')); ?>"></a> 
                         </td>
                     </tr>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="<?php echo e(route('deleteSubCategory')); ?>" method="post">
              <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactiveSubCategory')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activeSubCategory')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '', category = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_subcategory')); ?>",
              method:"GET",
              data:{
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\backendGrovery\resources\views/superadmin/subcategory/manage.blade.php ENDPATH**/ ?>