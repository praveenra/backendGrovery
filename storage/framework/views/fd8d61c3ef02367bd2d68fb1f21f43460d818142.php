         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="area">
                ...
                <a href="<?php echo e(url('superadmin/area/create')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Area Name</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo e($slider->area_name); ?></td>
                        <?php if($slider->area_status == 1): ?>
                        <td><a href="javascript:" class="badge badge-success active" data-id='<?php echo e($slider->area_id); ?>' style="cursor: pointer;">Active</a></td>
                        <?php else: ?>
                        <td><a href="javascript:" class="badge badge-danger inactive" data-id='<?php echo e($slider->area_id); ?>' style="cursor: pointer;">Inactive</a></td>
                        <?php endif; ?>
                        <td >
                           <a href="<?php echo e(url($edit).'/'.$slider->area_id.'/edit'); ?>"><img src="<?php echo e(asset('public/edit.svg')); ?>"></a>&nbsp;
                           <a class="delete" href="javascript:;" data-toggle="modal" data-id='<?php echo e($slider->area_id); ?>' data-target="#delete"><img src="<?php echo e(asset('public/delete.svg')); ?>"></a>
                         </td>
                     </tr>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="<?php echo e(route('deleteArea')); ?>" method="post">
              <?php echo csrf_field(); ?>
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="custom-width-modalLabel">Delete Area</h4>
                </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactiveArea')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activeArea')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_area')); ?>",
              method:"GET",
              data:{
                status:status
              },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\backendGrovery\resources\views/superadmin/area/manage.blade.php ENDPATH**/ ?>