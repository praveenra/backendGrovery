...
<div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               ...
               <form action="<?php echo e(url('superadmin/city_store')); ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label for="city_name">City Name</label>
                  <input type="text" name="city_name" class="form-control" placeholder="City Name" style="width: 50%;">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <input type="text" class="form-control" placeholder="Longitude" name="long" id="long" readonly>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="city_status">City Status:</label><br>
                    <input type="radio" id="active" name="city_status"  value="1" >
                    <label for="active">Active</label>
                    <input type="radio" id="inactive" name="city_status" value="0">
                ...
                <div class="form-group">
                  <label class="switch" for="buisness_switch">
                    <input type="checkbox" name="buisness" id="buisness_switch" class="check">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="buisness_image" id="buisness_image1" class="form-control" onchange="loadImage(this);" style="width: 50%;"disabled="">
                    <div style="margin-left:10px;"><br>
                        <img src="" id="img_preview">
                    </div>
                  <input type="text" name="buisness_text" id="buisness_text1" class="form-control" style="width: 50%;"disabled="">
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="promo_available">
                    <span class="slider round"></span>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="pay_by_cash">
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="other_payment_method">
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="wallet_in_cash">
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="wallet_in_other">
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <label class="switch">
                    <input type="checkbox" name="received_cash_payment">
                    <span class="slider round"></span>
                  </label>
                ...
                <div class="form-group">
                  <input type="text" name="min_amount" placeholder="Minimum Amount in Wallet" class="form-control">
                </div>
     ...
     <div class="mapform" >
      ...
      <div class="form-group">
        <label class="switch">
         ...
         <input type="checkbox" name="use_radius" id="use_radius">
        <span class="slider round"></span>
        </label>
      ...
      <div class="form-group">
      <input type="text" name="radius" id="radius" class="form-control" placeholder="Radius" disabled>
      </div>
  ...
  <div id="Zone" class="w3-container city grid" style="display:none">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label class="switch">
        <input type="checkbox" id="use_zone" name="zone">
        <span class="slider round"></span>
        </label>
        <label for="wallet_in_other">Zone Business</label>
        <input type="text" name="vertices" id="vertices" class="form-control" readonly>
      </div>


      <div class="form-group">
      <input type="text" name="zone_name" id="zone" class="form-control" placeholder="Zone Name" disabled>
      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/city/add.blade.php ENDPATH**/ ?>