...
<script src="<?php echo e(asset('public/admin/js/misc.js')); ?>"></script>
<!-- endinject -->
<!-- Custom js for this page -->
<script src="<?php echo e(asset('public/admin/js/dashboard.js')); ?>"></script>
<script src="<?php echo e(asset('public/admin/js/todolist.js')); ?>"></script><?php /**PATH /home/ubuntu/Documents/mahe/latestcodeteam/GroveryVThree/Grovery/resources/views/common/admin/footer_script.blade.php ENDPATH**/ ?>