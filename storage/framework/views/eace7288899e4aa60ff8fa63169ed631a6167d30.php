         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="plan">
                ...
                <a href="<?php echo e(url('superadmin/plan_form')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Plan Name</th>
                  ...
                  <tbody>
                     <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                     <tr>
                        ...
                        <?php endif; ?>
                        <td >
                           <a href="<?php echo e(url('superadmin/plan_form')); ?>/<?php echo e($data->id); ?>"><img src="<?php echo e(asset('public/edit.svg')); ?>"></a>&nbsp;
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="<?php echo e(route('deletePlan')); ?>" method="post">
              <?php echo csrf_field(); ?>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactivePlan')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activePlan')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_plan')); ?>",
              method:"GET",
              data:{
                status:status
              },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/plan/manage.blade.php ENDPATH**/ ?>