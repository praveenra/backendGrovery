      ...
      <div class="col-lg-12 grid-margin stretch-card">
         ...
         <div class="card">
            <div class="card-body table-responsive">
               <table class="table table-striped" id="contactus">
                <a href="javascript:" type="button" class="btn btn-primary" style="float: left;" data-toggle="modal" data-target="#filter">Filter</a>
                <a href="<?php echo e(url('superadmin/contactus/create')); ?>" type="button" class="btn btn-info" style="float: left; position: relative; left: 10px;">Add New</a>
                  <thead>
                     <tr>
                        <th>S. No</th>
                        <th>Email</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo e($slider->phone_no); ?></td>
...
<div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
              <form action="<?php echo e(route('deleteContact')); ?>" method="post">
              <?php echo csrf_field(); ?>
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="custom-width-modalLabel">Delete Contact</h4>
                </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
    ...
    $(".active").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('inactiveContactUs')); ?>?id="+id,
    ...
    $(".inactive").click(function(){
      ...
      $.ajax({
        type:"GET",
        url:"<?php echo e(route('activeContactUs')); ?>?id="+id,
        success:function(res){
          window.location.reload();
        }
      });
   ...
   $(document).ready(function(){
      ...
      function filter(status = '') {
          $.ajax({
              url:"<?php echo e(url('superadmin/filter_contactus')); ?>",
              method:"GET",
              data:{
                status:status
              },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel\backendGrovery\resources\views/superadmin/contactus/manage.blade.php ENDPATH**/ ?>